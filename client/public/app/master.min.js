...
var csrfkey=document.getElementsByName("csrfkey")[0].value;function errorReader(prefix,model){return function(){var args=Array.prototype.slice.call(arguments);var path=args.map(function(x){if(x===parseInt(x,10)){return "["+x+"]";}
...
var myAPI={createProtest:function(data){return new Promise(function(resolve,reject){m.request({method:"POST",url:"/protests/create",data:data,withCredentials:true,headers:{"X-csrfkey":csrfkey}}).then(resolve).catch(function(e){console.log(e);reject(e);})})},getProtestByID:function(id){return new Promise(function(resolve,reject){m.request({method:"GET",url:"/protests/"+id,headers:{"X-csrfkey":csrfkey},}).then(resolve).catch(function(e){console.log(e);reject(e);})})},getProtestByIDAndPwd:function(id,password){return new Promise(function(resolve,reject){m.request({method:"POST",url:"/protests/"+id,data:{pwd:password},headers:{"X-csrfkey":csrfkey},}).then(resolve).catch(function(e){console.log(e);reject(e);})})},getProtestsByAuthor:function(id){return new Promise(function(resolve,reject){m.request({method:"GET",url:"/protests/by_author/"+id,}).then(resolve).catch(function(e){console.log(e);reject(e);})})},searchProtests:function(data){return new Promise(function(resolve,reject){m.request({method:"POST",url:"/protests/search",headers:{"X-csrfkey":csrfkey},data:data}).then(resolve).catch(function(e){console.log(e);reject(e);})})},login:function(model){return new Promise(function(resolve,reject){m.request({method:"POST",url:"/admin/login",headers:{"X-csrfkey":csrfkey},data:model,}).then(resolve).catch(function(e){console.log(e);reject(e);})})},captchaNew:function(){return new Promise(function(resolve,reject){m.request({url:"/captcha/new",headers:{"X-csrfkey":csrfkey},}).then(resolve).catch(function(e){console.log(e);reject(e);})})},createContact:function(data){return new Promise(function(resolve,reject){m.request({method:"POST",url:"/contacts/create",headers:{"X-csrfkey":csrfkey},data:data,}).then(resolve).catch(function(e){console.log(e);reject(e);})})},getContacts:function(){return new Promise(function(resolve,reject){m.request({method:"GET",url:"/contacts/list",headers:{"X-csrfkey":csrfkey},}).then(resolve).catch(function(e){console.log(e);reject(e);})})},delContact:function(id){return new Promise(function(resolve,reject){m.request({method:"POST",url:"/contacts/delete/"+id,headers:{"X-csrfkey":csrfkey}}).then(resolve).catch(function(e){console.log(e);reject(e);})})},}
